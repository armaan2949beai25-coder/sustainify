...
// 5. Learning Styles Interactivity
function showStyle(text) {
    const res = document.getElementById('style-result');
    res.innerText = text;
    res.classList.remove('hidden');
    res.style.animation = 'none';
    res.offsetHeight; // trigger reflow
    res.style.animation = 'fadeInVoice 0.6s ease-out forwards';
}
